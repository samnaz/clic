...
<script language='javascript'>
    ...
    function ListUsers(){
        $.ajax({
            type: "GET",
            url: "/clic/Accounts/getusers.json",
            cache: false,
    ...
    //$('.pagination-info').appendTo('#btn-menu-col');
        ...
        $.ajax({
            type: "GET",
            url: "/clic/Accounts/statusEnabled.json",
            cache: false,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            data: "",
        ...
        $.ajax({
            type: "GET",
            url: "/clic/Accounts/statusDisabled.json",
            cache: false,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            data: "",
    ...
    function actionFormatter(value, row, index) {
        ...
        return [
            '<a href="/clic/Accounts/edituser/' + row["UserId"] + '" title="Editar">',
                '<img style="width:15px;margin:5px;" src="/clic/img/icons/icon_edit.png" alt="Editar">',
            '</a>',
            '<a href="/clic/Accounts/viewuser/' + row["UserId"] + '" title="Detalles">',
                '<img style="width:15px;margin:5px;" src="/clic/img/icons/icon_view.png" alt="Detalles">',
            '</a>',
            ...
            '<a href="javascript:void(0)" onClick="ShowModalChangeStatus(' + row["UserId"] +',' + row["UserStatusId"] + ')" title="'+ texto +'">',
                '<img style="width:15px;margin:5px;" src="/clic/img/icons/'+ imgSrc +'" alt="'+ texto +'">',
            '</a>'
        ].join('');
    }
    ...
    function DeleteUser(id) {
        $.ajax({
            data: "",
            type: 'GET',
            url: '/clic/Accounts/deleteuser/' + id,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function(data) {
				if (data.status==1){
