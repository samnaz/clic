...
<script language='javascript'>    
    ...
    function ListUsers(){
        $.ajax({
            type: "GET",
			url: "/clic/Reports/getuserlessons/"+$("#cmbUsers").val()+".json",
            cache: false,
    ...
    function actionFormatter(value, row, index) {
        return [           
            ...
            '<img style="width:15px;margin:5px;" src="/clic/img/icons/icon_view.png" alt="Ver Detalle de Tareas">',
            '</a>'
        ].join('');
    }
    ...
    function TaskByUser(id, lessonId) {
        $.ajax({
            data: "",
            type: 'GET',
            url: '/clic/Reports/getuserpages/' + id+'/'+lessonId,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function(data) {
	...
	function ShowTask(userId, id) {
        $.ajax({
            data: "",
            type: 'GET',
            url: '/clic/Reports/getuserpage/' + userId+'/'+id,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function(data) {
				...
				if (data.userpage.Id == 7)
					...
					window.open("/clic/img/userlessons/" + data.userpage.File);
				else
