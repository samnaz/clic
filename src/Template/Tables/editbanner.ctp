	...
	<div class="row">
		<div class="col-sm-12">
			...
			<div class="myaccordion" id="activeAcord">Datos de la Publicidad</div>
						<div class="panel">
							<?php $bannerId = $banner['Id']?>
						       <?php
                                echo $this->Form->create(null, ['url' => ['controller' => 'Tables', 'action' => 'editbanner', $bannerId]
                                ...
                                <div class="row">
                                    ...
                                    <?php
                                        $options = ['1' => 'Html', '2' => 'Imagen'];
                                            $attributes = ['onclick' => 'rbClick(this.value)','legend' => false, 'label' => ['style' => 'font-weight:bold']];
							...
							<div class="form-group">
                                <div class="row">
                                    ...
                                    <?php
                                        echo $this->Form->text('txtTitle', ['required' => 'required', 'id' => 'txtTitle', 'class' => 'col-sm-4 form-input-style', 'placeholder' => 'Título...', 'name' => 'txtTitle', 'maxlngth'=>'50', 'value' => $banner['Title']]);
                                    ?>
                                </div>
                            </div>  
							...
							<div class="form-group" id='rowHtml' style='display:none'>
                                <div class="row">
                                    <label class="col-sm-3 text-right form-label-style">Html del Banner:</label>
                                    <?php
                                        echo $this->Form->text('txtBanner', ['rows' => '5', 'required' => 'required', 'id' => 'txtBanner', 'class' => 'col-sm-4', 'placeholder' => 'Html...', 'name' => 'txtBanner', 'type'=>'textarea', 'value' => $banner['Description']]);
                                    ?>
                                </div>
                            </div>  
