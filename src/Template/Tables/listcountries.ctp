...
<script language='javascript'>
    ...
    function ListCountries(){
        $.ajax({
            type: "GET",
            url: "/clic/Tables/getCountries.json",
            cache: false,
    ...
    function actionFormatter(value, row, index) {
                return [
            '<a href="/clic/Tables/editcountry/' + row["CountryId"] + '" title="Editar">',
                '<img style="width:15px;margin:5px;" src="/clic/img/icons/icon_edit.png" alt="Editar">',
            '</a>',
            '<a href="/clic/Tables/viewcountry/' + row["CountryId"] + '" title="Detalle">',
    ...
    function DeleteCountry(id) {
        $.ajax({
            data: "",
            type: 'GET',
            url: '/clic/Tables/deleteCountry/' + id,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function(data) {
