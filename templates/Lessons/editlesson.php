...
<div class="div-container">
	<div class="row">
		<div class="col-sm-12">
            ...
            <div class="panel">
				<?php $lessonId = $lesson['Id']?>                          
					<?php
						echo $this->Form->create(null, ['url' => ['controller' => 'Lessons', 'action' => 'editlesson', $lessonId]
				...
				?> 
					<div class="form-group">
						<div class="row">
							...
							<?php
								echo $this->Form->text('txtDay', ['required' => 'required', 'id' => 'txtDay', 'class' => 'col-sm-4 form-input-style', 'placeholder' => 'Día...', 'name' => 'txtDay', 'maxlength'=>'5', 'type'=>'number', 'value' => $lesson['Day']]);
							?>
						</div>
					</div>
					<div class="form-group">
