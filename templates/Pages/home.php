...
<body>
    ...
    <div class="scrollmenu">
        ...
        <img class="telefonos animated fadeInUp " src="/img/telefonos.png" alt="telefonos">
        
    </div>
        <div class="row">
            <div class="seccion1">
                <div class="col-md-6">
                    <img class="tel-vertical animated fadeInUp " src="/img/tel-vertical.png" alt="telefono vertical">
                </div>
        ...
        <div class="row">
            <div class="seccion2">
                ...
                <div class="col-md-6">
                    <img class="tel-vertical animated fadeInUp " src="/img/tel-vertical-2.png" alt="telefono vertical 2">
                </div>
            </div>
        </div>
        <div class="bgfooter"> 
            ...
            <div class="row">
                <img class="tel-footer animated fadeInUp " src="/img/telefonos-footer.png" alt="telefonos footer">
            </div>
        </div>
</body>
</html>
